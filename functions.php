 ...
 *  予約CTAセクションを生成
 =============================================== */
function generate_reserve_cta($add_id = false) {
  $id_attr = $add_id ? ' id="reserve-section"' : '';
?>
  <section<?php echo $id_attr; ?> class="reserve-cta">
    ...
    <div class="reserve-cta__button-area">
      <a href="<?php echo esc_url(home_url()); ?>/reserve/" class="reserve-cta__button">
        ...
        <span class="reserve-cta__button__text">オンライン予約<br>（本店）</span>
      </a>
      <a href="https://beauty.hotpepper.jp/kr/slnH000384472/" class="reserve-cta__button" target="_blank">
        <span class="material-symbols-outlined">calendar_clock</span>
        <span class="reserve-cta__button__text">オンライン予約<br>（新店）</span>
      </a>
